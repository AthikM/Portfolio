...
const Contact = () => {
    ...
    const email="athik.sde@gmail.com";
    const address="Salem"
        ...
        <div className="cc-contact" id='contact-page' >
            ...
            <div className="cc-right" data-aos="zoom-in">
                    ...
                    <div className="social-icon">
                        ...
                        <div className="icon-float s1"><a href="https://www.instagram.com/itsathik/" target='_blank' rel='noopener noreferrer'><AiOutlineInstagram size={25}></AiOutlineInstagram></a></div>
                        <div className='icon-float s2'><a href="https://github.com/Athik21/" target='_blank' rel='noopener noreferrer'><FiGithub size={25}></FiGithub></a></div>
                        <div className='icon-float s3'><a href="https://www.linkedin.com/in/athik-mohamed-0016b520a/" target='_blank' rel='noopener noreferrer'><GrLinkedinOption size={25}></GrLinkedinOption></a></div>
                        </div>
                    </div>
                </div>
            </div>
